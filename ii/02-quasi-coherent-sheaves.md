...
By ([EGA III 1.4.17](https://jcreinhold.github.io/ega/iii/08-ch3-01-cohomology-affine-schemes.html#14-application-to-the-cohomology-of-arbitrary-preschemes)), in order that the $\mathcal{H}^{i}_{Z}(F)$ be quasi-coherent it therefore suffices that the
...
This follows immediately from Corollary 2 and ([EGA I 6.6.4](https://jcreinhold.github.io/ega/i/01-06-finiteness-conditions.html#66-quasi-compact-morphisms)).
...
Equality (4.1) then follows from ([EGA I 1.1.3.7](https://jcreinhold.github.io/ega/i/01-01-affine-schemes.html#11-the-prime-spectrum-of-a-ring)); (4.2) and (4.3) follow from the cohomology exact sequence (I
...
notation of ([EGA III § 1](https://jcreinhold.github.io/ega/iii/08-ch3-01-cohomology-affine-schemes.html#1-cohomology-of-affine-schemes)),[^N.D.E-II-3] one has:
...
For $i = 0$ and $i = 1$, one uses the exact sequences (4.2) and ([EGA III 1.4.3.2](https://jcreinhold.github.io/ega/iii/08-ch3-01-cohomology-affine-schemes.html#14-application-to-the-cohomology-of-arbitrary-preschemes)); if $i \geqslant 2$, one uses (4.3)
and ([EGA III 1.4.3.1](https://jcreinhold.github.io/ega/iii/08-ch3-01-cohomology-affine-schemes.html#14-application-to-the-cohomology-of-arbitrary-preschemes)). This gives us isomorphisms functorial in $M$. One verifies that, up to a sign depending only on
...
We shall now prove 6.a); this is a local question on $X$. By Corollary 4 and ([EGA I 1.3.9](https://jcreinhold.github.io/ega/i/01-01-affine-schemes.html#13-sheaf-associated-to-a-module) and 1.3.12) we may assume that
...
For every $n > 0$, one has ([EGA III 1.1.4.1](https://jcreinhold.github.io/ega/iii/08-ch3-01-cohomology-affine-schemes.html#11-review-of-the-exterior-algebra-complex)) an exact sequence
...
[^N.D.E-II-3]: *N.D.E.* Recall that $H_{\bullet}(f, M)$ is the Koszul cohomology
    $H_{\bullet}(\operatorname{Hom}(K_{\bullet}(f), M))$ of $f$ ([EGA III 1.1.2](https://jcreinhold.github.io/ega/iii/08-ch3-01-cohomology-affine-schemes.html#11-review-of-the-exterior-algebra-complex)) with values in $M$, and that
