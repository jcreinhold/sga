...
the sheaf $X$. Let $F \in Ob \hat{C}$ be defined as follows: for each $S$ of $C$,*[^N.D.E-IV-43]
...
every $s \in S$, there exists, by (the proof of)
[EGA IV_4, 17.16.2](https://jcreinhold.github.io/ega/iv/30-ch4-17-smooth-unramified-etale-morphisms.html#1716-quasi-sections-of-flat-or-smooth-morphisms),
an affine subscheme $X(s)$ of a certain $S_{i}$, such that $s \in f_{i}(X(s))$ and that the morphism
$g_{i} : X(s) \to S$, restriction of $f_{i}$, is flat, of finite presentation, and quasi-finite. Then, $g_{i}(X(s))$ is
an open neighborhood $U(s)$ of $s$
...
and, $S$ being affine, it is covered by a finite number of such opens $U(s_{j})$, `j = 1, ..., n`. Consequently, $X' =
...
canonical topology, and for each scheme $S$, one has*[^N.D.E-IV-63]
...
```text
(X/R)(S) = { closed (resp. open, resp. retrocompact, resp. open retrocompact)
...
"isotrivial". The chaotic topology[^N.D.E-IV-64] appears at the foot of the following lattice of topologies:
...
By
[EGA I, 5.3.13](https://jcreinhold.github.io/ega/i/01-05-reduced-preschemes-and-separation.html#53-diagonal-graph-of-a-morphism),
$\sigma$ is an immersion. Let us define $H = G \times_{X} S$ by the diagram below, in which the two squares are
cartesian:
...
[^N.D.E-IV-49]: N.D.E.: One also says "pseudo-torsor", cf.
    [EGA IV_4, 16.5.15](https://jcreinhold.github.io/ega/iv/29-ch4-16-differential-invariants.html#165-relative-tangent-sheaves-and-bundles-derivations).
    On the other hand, the more general notion of formally homogeneous object (not necessarily principal homogeneous),
    is defined in the addendum 6.7.1 at the end of this Exposé.
...
[^N.D.E-IV-57]: N.D.E.: Let $P''_{2}$ denote the set of finite surjective families, composed of flat morphisms of $C '$
    ...
    coincides with the topology generated by $P$ and $P''_{2}$. This follows from the results of
    [EGA IV_4, § 17.16](https://jcreinhold.github.io/ega/iv/30-ch4-17-smooth-unramified-etale-morphisms.html#1716-quasi-sections-of-flat-or-smooth-morphisms)
    on quasi-sections; see the proof of 6.3.1. Let us cite here the following particular case of EGA IV_4, 17.16.2: let
    $S$ be affine and $f : X \to S$ a surjective flat morphism locally of finite presentation; then there exists a
    morphism $S' \to S$ faithfully flat, of finite presentation, quasi-finite, with $S'$ affine, and an $S$-morphism
    $S' \to X$.
...
[^N.D.E-IV-62]: N.D.E.: cf.
    [EGA I, 6.6.4](https://jcreinhold.github.io/ega/i/01-06-finiteness-conditions.html#66-quasi-compact-morphisms) for
    "quasi-compact",
    ...
    for "locally of finite presentation",
    ...
    for "faithfully flat", and
    [EGA IV_4, 17.3.3](https://jcreinhold.github.io/ega/iv/30-ch4-17-smooth-unramified-etale-morphisms.html#173-smooth-unramified-étale-morphisms)
    for "étale".
...
[^N.D.E-IV-63]: N.D.E.: Recall that a subscheme $Z$ of a scheme $T$ is said to be *retrocompact* if the immersion $Z
    \hookrightarrow T$ is quasi-compact, cf.
    [EGA 0_III, 9.1.1](https://jcreinhold.github.io/ega/iii/02-ch0-09-constructible-sets.html#91-constructible-sets).
