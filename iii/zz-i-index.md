...
| `Alf_/k` (category of `k`-algebras of finite length)                    | 515                                                             |
| `α_{p,k}`                                                               | 99                                                              |
...
| Connected component `G⁰`                                                | 299, 308, 345                                                   |
...
| `c(X, Y, f)`                                                            | 152                                                             |
| `Δ_{X/S}^{(1)}`                                                         | 105                                                             |
| `S`-Derivation (of an `S`-morphism `Y → X`)                             | 443                                                             |
| `Cb` (= `Ĉ`)                                                            | 1                                                               |
...
| `S`-Deviations (of order `⩽ n`)                                         | 441                                                             |
| Fiber dimension                                                         | 350                                                             |
| `D_{O_S}(M)`                                                            | 52                                                              |
| Cartier duality                                                         | 461, 547                                                        |
| `d(Y₀, Y)`                                                              | 148                                                             |
| Affine envelope `G_af`                                                  | 405, 427                                                        |
...
| Functor `Aut(X)`                                                        | 9, 12                                                           |
| Ring functor `O` on `(Sch)`                                             | 22                                                              |
| Functor `Hom(X, Y)`                                                     | 7                                                               |
| Functor `Hom_{Z/S}(X, Y)`                                               | 50                                                              |
| Functor `∏_{Z/S} Y`                                                     | 51, 368, 373                                                    |
| Functor `X ↦ X_e`                                                       | 542                                                             |
...
| `G`-`O`-modules                                                         | 19                                                              |
| `G`-`O_S`-modules                                                       | 27, 43                                                          |
| `G_red` over a perfect field                                            | 291                                                             |
| `G_red` over a non-perfect field                                        | 297                                                             |
...
| Groupoids                                                               | 251                                                             |
| `H`-set                                                                 | 62                                                              |
| `h_A` (functor `Hom_{Alp/k}(A, −)`)                                     | 515                                                             |
| Height `⩽ 1` (`S`-groups, formal groups)                                | 489, 492, 579                                                   |
| Height `⩽ n` (`S`-group, formal group)                                  | 464, 575, 590                                                   |
| `H₀^∨(S, P)`                                                            | 205                                                             |
| `h_M^c` (functor `Hom_c(M, −)`)                                         | 506                                                             |
...
| `Lie(X/S)`                                                              | 63, 70                                                          |
| `Lie(X/S, M)`                                                           | 63, 70                                                          |
| `Lie(f)` derived morphism of `f`                                        | 70                                                              |
| `Lie₀(X/S, M)`                                                          | 77                                                              |
| `Lie(G/S)`                                                              | 89, 90                                                          |
| `Lie(G_{m,S}/S)`, `Lie(D_S(M)/S)`                                       | 91                                                              |
| `Lie(_nG)` derived morphism of `g ↦ g^n`                                | 64                                                              |
| Inverse limits of group schemes                                         | 396                                                             |
| Linearity of affine algebraic groups flat over `S` regular of dim `⩽ 2` | 433                                                             |
| Linearity of affine algebraic groups over a field                       | 417                                                             |
| Smoothness of `G / Fr^n G`                                              | 493                                                             |
...
| Morphism `g ↦ g^n` is étale                                             | 495                                                             |
| Morphism `g ↦ g^n` is zero                                              | 496                                                             |
...
| Completed tensor product `⊗̂`                                            | 508, 509, 511, 516, 519                                         |
...
| Representability of `∏_{Z/S} Y`                                         | 368, 373                                                        |
...
| `Ŝ_k(E)` (completed symmetric algebra)                                  | 523                                                             |
| Subgroup generated by `f : X → G`                                       | 378                                                             |
| `Spec*(U)`                                                              | 456                                                             |
| `Spf*(C)`                                                               | 530                                                             |
| `Stab_G(x)`                                                             | 15                                                              |
| Stabilizer                                                              | 15, 44                                                          |
...
| `Υ(A)` (maximal open ideals of `A`)                                     | 502                                                             |
| `Vaf_/k` (category of formal varieties over `k`)                        | 518                                                             |
| `Vaf_/S^{f♭}`                                                           | 525                                                             |
| `Vaf_/k^ét`                                                             | 539                                                             |
| Abelian variety                                                         | 428                                                             |
...
| `X̂_{/S}` (formal variety associated to the `S`-scheme `X`)              | 525                                                             |
| Yoneda (lemma of)                                                       | 1                                                               |
