...
1.3.1), $G$ is smooth over $S$ at the point $\epsilon(s_{0})$ (EGA IV₄, 17.5.1), i.e. there exists an open neighborhood
...
$\kappa(s_{0})$ (cf. EGA IV₄, 17.15.10 (iii)). Thus there exists $S' \to S$ étale equipped with a point $s'_{0}$ mapping
...
*be a morphism of $S$-group functors. One says that $p$ is* normalized by $T$ with multiplier $\alpha$ *if it satisfies
