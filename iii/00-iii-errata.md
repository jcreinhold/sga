...
- p. 24, at the level of page 33 of the original: add "of $r$ copies" before "of $n G =$". And, 6 lines below, replace
  $n G_{m,S'}$ by $(n G_{m,S'})^{r}$.
...
- p. 38, line above C), $r$ should be $\alpha$.
...
- p. 45, Th. 3.1 (v): the 1st formula is incorrect and $Y$ is undefined. (This error appears in the original.) One
  ...
  \alpha^{\vee}(z^{-1})$, hence $w_{\alpha}(X)^{2} = \alpha^{\vee}(-1)$ gives
    ...
    Finally, $X^{-1}$ and $Y^{-1}$ are defined in Corollary 2.6: one has $XX^{-1} = 1$ and $Y^{-1} = z^{-1} X^{-1}$, hence indeed
    $-z^{-1} = -X Y^{-1}$.
...
- p. 210, line above 6.2: replace $-X^{-1}_{-\alpha}$ by $-X^{-1}_{\alpha}$.

### 1.6. Exposé XXIV

- p. 245, line 8 of the proof of 4.5.1: $o\sim$ should be `où`.

### 1.7. Exposé XXVI

- p. 311, diagram of 4.5.3: extra parenthesis before the last $O_{f}$.
