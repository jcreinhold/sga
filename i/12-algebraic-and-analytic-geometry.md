...
$g*g_{*}(\mathcal{O}_{X}'(n)) \to \mathcal{O}_{X}'(n)$ is surjective ([EGA III 2.2.1](https://jcreinhold.github.io/ega/iii/09-ch3-02-cohomology-projective-morphisms.html#22-the-fundamental-theorem-of-projective-morphisms)). If one puts $F =
